...
TEST(Perft, ChessProgrammingResults)
{
    ...
    {
        const auto results = perft("rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1", 5);
    ...
    {
        const auto results =
            perft("r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -", 4);
    ...
    {
        const auto results = perft("8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - -", 5);
    ...
    {
        const auto results =
            perft("r2q1rk1/pP1p2pp/Q4n2/bbp1p3/Np6/1B3NBn/pPPP1PPP/R3K2R b KQ - 0 1", 4);
        EXPECT_EQ(results[0].node_count, 6);
        EXPECT_EQ(results[1].node_count, 264);
        EXPECT_EQ(results[2].node_count, 9467);
        EXPECT_EQ(results[3].node_count, 422333);
    ...
    {
        const auto results = perft("rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8", 4);
