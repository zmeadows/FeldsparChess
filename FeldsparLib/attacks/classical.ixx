...
export constexpr __ALWAYS_INLINE Bitboard get_bishop_attacks(Square sq, Bitboard occupied)
{
...
export constexpr __ALWAYS_INLINE Bitboard get_rook_attacks(Square sq, Bitboard occupied)
{
...
export constexpr __ALWAYS_INLINE Bitboard get_queen_attacks(Square sq, Bitboard occupied)
{
    return get_bishop_attacks(sq, occupied) | get_rook_attacks(sq, occupied);
}

export constexpr __ALWAYS_INLINE Bitboard xray_rook_attacks(Bitboard occ, Bitboard blockers, Square rook_square)
{
...
export constexpr __ALWAYS_INLINE Bitboard xray_bishop_attacks(Bitboard occ, Bitboard blockers, Square bishop_square)
{
