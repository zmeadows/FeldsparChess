...
export constexpr __ALWAYS_INLINE Bitboard get_knight_moves(Square sq) { return KNIGHT_ATTACKS[sq]; }
...
export __ALWAYS_INLINE constexpr Bitboard get_king_moves(Square sq) { return KING_ATTACKS[sq]; }
...
export constexpr __ALWAYS_INLINE Bitboard get_pawn_attacks(Square sq, Color color)
{
