...
double perft_benchmark(const std::string& name, U64 depth, U64 ntimes, const std::string& fen)
{
    ...
    to_stdout("\tMNodes Traversed: {}\n", node_count);
    to_stdout("\tTotal Time: {:.2f} seconds\n", duration);
    to_stdout("\tMNodes/sec: {:.2f}\n\n", mnodes_sec);
...
int main()
{
    ...
    total += perft_benchmark("Starting Position", 7, 2,
                             "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1");

    total += perft_benchmark("Kiwipete", 5, 25,
                             "r3k2r/p1ppqpb1/bn2pnp1/3PN3/1p2P3/2N2Q1p/PPPBBPPP/R3K2R w KQkq -");

    total += perft_benchmark("RookPawnEndGame", 7, 14, "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - ");

    total += perft_benchmark("Position4", 6, 4,
                             "r3k2r/Pppp1ppp/1b3nbN/nP6/BBP1P3/q4N2/Pp1P2PP/R2Q1RK1 w kq - 0 1");

    total += perft_benchmark("BugCatcher", 5, 30,
                             "rnbq1k1r/pp1Pbppp/2p5/8/2B5/8/PPP1NnPP/RNBQK2R w KQ - 1 8");

    total += perft_benchmark("StevenEdwards", 5, 30,
